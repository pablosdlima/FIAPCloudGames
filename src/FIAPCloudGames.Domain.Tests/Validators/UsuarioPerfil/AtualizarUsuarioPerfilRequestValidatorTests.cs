...
{
    public class AtualizarUsuarioPerfilRequestValidatorTests
    {
        private readonly AtualizarUsuarioPerfilRequestValidator _validator;

        public AtualizarUsuarioPerfilRequestValidatorTests()
        {
            _validator = new AtualizarUsuarioPerfilRequestValidator();
        }
        ...
        [Fact]
        public void Deve_ter_erro_quando_DataNascimento_for_mais_de_120_anos()
        {
            var request = new AtualizarUsuarioPerfilRequest
            {
                Id = Guid.NewGuid(),
        ...
        [Fact]
        public void Deve_ser_valido_quando_DataNascimento_nao_informada()
        {
            var request = new AtualizarUsuarioPerfilRequest
            {
                Id = Guid.NewGuid(),
        ...
        {
            var longUrl = "https://exemplo.com/" + new string('a', 490);
            var request = new AtualizarUsuarioPerfilRequest
            {
                Id = Guid.NewGuid(),
                UsuarioId = Guid.NewGuid(),
